...
data <- read.csv("~/Documents/Personomics_Research_Group/WAPIAW_2/figure_plotting/features/plotting.csv")

# default output file (png and optionally pdf) name (without file extension)
fname <- "~/Documents/Personomics_Research_Group/WAPIAW_2/figure_plotting/all_plots/features_plot"
print(fname)
...
data$method <- factor(
    ...
    levels = c(
	       ...
	       "Concatenated & Amplitude & PhenoAvg"
	       ),
    labels = c(
	       "Rest (Dadi et al. 2021)",
	       "Amplitude", 
	       "Rest (replication) ", 
	       "Rest & Amplitude", 
	       "Rest & PhenoAvg",	
...
#     labels = c("Rest (replication)", "Resid", "Amp", "Avg", "Concat",
#        "Rest & Amp", "Avg & Amp", "Concat & Amp",
#        "PhenoAvg", "Concat & Amp & PhenoAvg",
#        "All & Balance", "fMRI (Dadi et al. 2021)",
#        "Rest & PhenoAvg",
...
fig <- ggplot(
    ...
    ggtitle("Approximation Quality from Brain Data") +
