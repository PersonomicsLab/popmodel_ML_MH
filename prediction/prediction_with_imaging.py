...
parser.add_argument('-i', '--image_sub_index',
    default='/scratch/janine.bijsterbosch/WAPIAW_2/subj_lists/sub_list.csv',
    help='Subject index file corresponding to the imaging data', dest='image')
