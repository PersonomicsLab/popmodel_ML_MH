...
output=/scratch/janine.bijsterbosch/WAPIAW_2/task_residuals/prediction/joint_proj_cat_amp_meanfi_IQ_bal.csv
n_split=100
target=20016_Mean  # "20016-2.0" or "20016_Mean" for fluid intelligence, "20127-0.0" or "20127_Mean" for neuroticism, and "21003-2.0" for age
