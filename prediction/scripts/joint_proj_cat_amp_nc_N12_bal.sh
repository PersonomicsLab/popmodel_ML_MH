...
output=/scratch/janine.bijsterbosch/WAPIAW_2/task_residuals/prediction/joint_proj_cat_amp_nc_N12_bal.csv
n_split=100
target=20127-0.0  # "20016-2.0" or "20016_Mean" for fluid intelligence, "20127-0.0" for neuroticism, and "21003-2.0" for age
