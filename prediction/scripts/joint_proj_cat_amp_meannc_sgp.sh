...
sub_list=/scratch/janine.bijsterbosch/WAPIAW_2/heterogeneity/subj_list/x20127_0_0_sub_list_resting_state_separate_proj_cluster_003.csv
data_file=/scratch/janine.bijsterbosch/WAPIAW_2/imaging/joint_proj_concat.npy
output=/scratch/janine.bijsterbosch/WAPIAW_2/task_residuals/prediction/joint_proj_cat_amp_meannc_gp3.csv
n_split=100
target=20127_Mean  # "20016-2.0" or "20016_Mean" for fluid intelligence, "20127-0.0" for neuroticism, and "21003-2.0" for age
