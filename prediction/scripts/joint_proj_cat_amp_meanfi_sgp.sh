...
sub_list=/scratch/janine.bijsterbosch/WAPIAW_2/heterogeneity/subj_list/x20016_2_0_sub_list_resting_state_separate_proj_cluster_002.csv
data_file=/scratch/janine.bijsterbosch/WAPIAW_2/imaging/joint_proj_concat.npy
output=/scratch/janine.bijsterbosch/WAPIAW_2/task_residuals/prediction/joint_proj_cat_amp_meanfi_gp2.csv
n_split=100
