...
%
% Definitions: Left side = Part CCA (semipartial correlation - all the
% confounding variables are regressed out only for IV, not DV)
%              Rigt side = bipartial CCA
%              Both sides = partial CCA (confoundign varaibles regressed
%              out for IV and DV)
%
% Inputs:
